    ...
    <main class="container mt-5 pt-5">
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-6 text-center">
                <img src="../../assets/frontend/img/assets/frontend/img/pro_hong_01_1_a39e4cb35ec4496197dcfee43d79a73d_grande.jpg" alt="Demo Shop" class="img-fluid rounded shadow" style="max-width: 350px;">
            </div>
        </div>
        <div class="row">
